About napari-3d-counter-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/napari-3d-counter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/napari-3d-counter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add napari-3d-counter
# for installing globally
pixi global install napari-3d-counter
```
...
It is possible to list all of the versions of `napari-3d-counter` available on your platform:
...
```
pixi search napari-3d-counter --channel conda-forge
```
